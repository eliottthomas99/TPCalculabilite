...
def evolve_population(population):
    ...
    parents = graded_population[:GRADED_INDIVIDUAL_RETAIN_COUNT] # de 0 à GRADED_INDIVIDUAL_RETAIN_COUNT-1
 
    # Randomly add other individuals to promote genetic diversity
    for individual in graded_population[GRADED_INDIVIDUAL_RETAIN_COUNT:]: # de GRADED_INDIVIDUAL_RETAIN_COUNT à la fin
